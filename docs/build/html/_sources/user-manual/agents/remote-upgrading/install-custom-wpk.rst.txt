...
You have two options to perform this action:
    ...
    a. Overwrite the shipped root CA with your certificate. This will prevent your agent from upgrading using WPK packages from Fortishield.
...
Run the WPK package from the Fortishield manager:
...
.. code-block:: none
    ...
    Upgraded agents:
        Agent 001 upgraded: Fortishield v4.2.7 -> Fortishield v|FORTISHIELD_CURRENT|
