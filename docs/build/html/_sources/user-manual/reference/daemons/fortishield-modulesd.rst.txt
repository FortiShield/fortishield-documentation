...
.. meta::
  :description: The fortishield-modulesd program manages some of the Fortishield modules. Learn more about it in this section of the documentation.

.. _fortishield-modulesd:

fortishield-modulesd
==============

The fortishield-modulesd program manages the Fortishield modules described below.

.. topic:: Database wodle

  The Fortishield core uses list-based databases to store information related to agent keys, and FIM/Rootcheck event data. This information is highly optimized to be handled by the core.

  In order to provide well-structured data that can be accessed by the user or the Fortishield API, new **SQLite-based databases** have been introduced in the Fortishield manager. The Database Synchronization Module is a **user-transparent component** that collects the following information from the core:
...
.. topic:: CIS-CAT wodle
  ...
  The CIS-CAT wodle allows you to run CIS policy scans visualizing the results of assessments in the Fortishield App. See the :doc:`CIS-CAT integration <../../capabilities/policy-monitoring/ciscat/ciscat>` for more information on this functionality.
