...
.. meta::
	:description: Check out this section about the local configuration of Fortishield and learn about the configuration options of the Fortishield-DB daemon.


.. _fortishield-db-config:
...
Configuration options for the :ref:`fortishield-db <fortishield-db>` daemon.
...
Configuration block to define the fortishield-db databases backup behavior.
