...
.. meta::
  :description: Learn more about the Fortishield local configuration, including configuration sections and supported installations, in this section of our documentation.
...
Fortishield can be installed in two ways: as a manager by using the "server/manager" installation type and as an agent by using the "agent" installation type.
...
+---------------------------------------------------------------------+------------------------+
| :doc:`fortishield_db <fortishield-db-config>`                                   | manager                |
+---------------------------------------------------------------------+------------------------+
