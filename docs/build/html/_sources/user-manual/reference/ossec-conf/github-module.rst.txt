...
.. meta::
  :description: Find out how to configure the Fortishield GitHub module. Learn more about it in this section of the Fortishield documentation.
...
By default, when Fortishield starts it will only read all log content from GitHub since the manager started.
