...
.. meta::
   :description: Learn how to keep a backup of key files of your Fortishield agent installation.
  
Fortishield agent
===========

To create a backup of your Fortishield agent installation follow these steps.
   ...
   .. tabs::
      ...
      .. group-tab:: Windows
         ...
         .. code-block:: doscon
            ...
            > set datetime=%datetime::=_%
            > set datetime=%datetime:.=_%
            > set bkp_folder=%userprofile%\fortishield_files_backup\%datetime%
...
Backing up a Fortishield agent
------------------------

#. Back up Fortishield agent data, certificates, and configuration files.
