...
Before making a custom decoder, the first step should always be running the event log through :ref:`fortishield-logtest <fortishield-logtest>` to know where to start.
...
Allows Fortishield to track events over multiple log messages based on a decoded id.
