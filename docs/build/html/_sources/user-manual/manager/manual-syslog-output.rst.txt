...
.. meta::
  :description: Learn more about how to configure syslog output in the Fortishield server administration section of our documentation. 
...
Fortishield may be configured to send alerts to syslog as follows:
...
To apply the changes, restart Fortishield:
