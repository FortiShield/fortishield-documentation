...
Fortishield email alerts does not support SMTP servers with authentication such as Gmail. However, you can use a server relay, like Postfix, to send these emails. Follow this guide for instructions on configuring Postfix with Gmail.
...
#. Configure email notifications in the Fortishield server ``/var/ossec/etc/ossec.conf`` file as follows:
