...
.. meta::
   :description: Discover how to customize the appearance of your Fortishield dashboard and PDF reports.

How to set up custom branding
=============================
        
The Fortishield dashboard white-labeling feature allows you to replace the following elements with custom ones.

-  Logos in the Fortishield dashboard.

   -  App loading logo
   -  Health check logo
   -  Fortishield dashboard home logo

-  Logo, header, and footer in PDF reports.

Custom logos in the Fortishield dashboard
-----------------------------------

App loading and Health check logos
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

To use your own App loading and Health check logos in the Fortishield dashboard, do the following.

#. Click on **Indexer/dashboard management** > **App Settings**.
#. Under the **Custom branding** section, set up the following properties:

   -  ``customization.logo.app``. This property sets the `App loading logo` image. It has a size limit of 1 MB. It replaces the logo image in the Fortishield loading animation when a new section initializes. Recommended size: 300 pixels width, 70 pixels height.
...
Once you are done setting your custom logo images, you can find them saved in ``/usr/share/fortishield-dashboard/plugins/fortishield/public/assets/custom/images/``.

Fortishield dashboard home logo
^^^^^^^^^^^^^^^^^^^^^^^^^

To customize the `Fortishield dashboard home logo` in the top header, do the following.

#. Edit ``opensearch_dashboards.yml``. You can find this file in the following locations:

   -  ``/etc/fortishield-dashboard/``
   -  ``/usr/share/fortishield-dashboard/config/`` for Docker installations.
...
Once you are done setting your custom logo image, you can find it saved in ``/usr/share/fortishield-dashboard/plugins/fortishield/public/assets/custom/images/``.
...
**customization.enabled**
    ...
    Enables and disables custom branding of the Fortishield dashboard and PDF reports.
...
**customization.logo.app**
    ...
    This logo is used as loading indicator while the user is logging into Fortishield API.
    It is saved as ``/usr/share/fortishield-dashboard/plugins/fortishield/public/assets/custom/images/customization.logo.app.<format>``.
...
**customization.logo.healthcheck**
    ...
    It is saved as ``/usr/share/fortishield-dashboard/plugins/fortishield/public/assets/custom/images/customization.logo.healthcheck.<format>``.
...
**customization.logo.reports**
    ...
    It is saved as ``/usr/share/fortishield-dashboard/plugins/fortishield/public/assets/custom/images/customization.logo.reports.<format>``.
