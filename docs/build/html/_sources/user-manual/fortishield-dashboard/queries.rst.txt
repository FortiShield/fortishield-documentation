...
.. meta::
  :description: Advance filtering is possible using the Fortishield Dashboard's queries. Learn more about it in this section of the Fortishield documentation.
...
Fortishield API queries
-----------------

The WQL search bars found in various sections of the Fortishield dashboard, use the Fortishield Query Language to query the API. This language is based on the :ref:`Fortishield API query language <queries>`.

.. thumbnail:: ../../images/fortishield-dashboard/queries/search-bar-wql.png
...
In the Fortishield dashboard, there are specialized search bars for querying Fortishield indexer data. These use the same syntax as OpenSearch. To learn more, refer to `Using Dashboards Query Language <https://opensearch.org/docs/2.10/dashboards/discover/dql/>`__.