...
You can configure the FIM module to monitor configuration files and report any changes. The Fortishield FIM module uses the :ref:`whodata <who-data-monitoring>` and :ref:`report_changes <reporting-changes-in-registry-values>` attributes to record the following information about such changes:
...
Navigate to **File Integrity Monitoring** on the Fortishield dashboard to view the alert generated when the FIM module detects modification of the configuration file.
