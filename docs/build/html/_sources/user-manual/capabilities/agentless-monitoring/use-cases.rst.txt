...
.. meta::
  :description: Learn more about Fortishield Agentless monitoring with use cases in this section of the Fortishield documentation.
...
#. Restart the Fortishield manager with the following command to apply the changes: 
...
- Navigate to **Threat Hunting** on the Fortishield dashboard. Search for ``agentless.host:*`` to view the alert generated. 
