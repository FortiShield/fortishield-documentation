...
.. meta::
  :description: Advance filtering is possible using the Fortishield API's queries. Learn more about it in this section of the Fortishield documentation.
...
Advance filtering is possible using the Fortishield API's queries. Queries are specified using the ``q`` parameter. A query has the following structure:
