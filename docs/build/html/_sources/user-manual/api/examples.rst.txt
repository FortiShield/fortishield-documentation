...
.. meta::
    :description: Check out some examples of the Fortishield API, an open source RESTful API that allows interaction with the Fortishield manager.
...
It is also possible to interact with the Fortishield API using Python as shown below:
...
The **Invoke-RestMethod** cmdlet was introduced in PowerShell 3.0.  It sends requests to the Fortishield API and handles the response.
