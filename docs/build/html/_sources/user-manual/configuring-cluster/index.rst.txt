...
.. meta::
  :description: Learn more about the cluster node configuration in Fortishield: master and worker nodes, labels, Filebeat, Splunk forwarder installation, and more. 

.. _configuring-cluster:

Deploying a Fortishield cluster
===========================
...
.. topic:: Cluster nodes configuration
    ...
    The Fortishield cluster is made up of manager type nodes. Only one of them will take the master role, the others will take the worker role. For both node types, the configuration file ``/var/ossec/etc/ossec.conf`` contains the cluster configuration values.
    ...
    Let's execute the following command (works on both worker and master nodes) to check that everything worked as expected:
        ...
        .. code-block:: none
            ...
            master-node    master  |FORTISHIELD_CURRENT|   fortishield-master
            worker01-node  worker  |FORTISHIELD_CURRENT|   172.22.0.3
...
.. topic:: Forwarder installation
    ...
    **Installing Filebeat:**
    ...
    | Type                                                                | Description                                    |
    +=====================================================================+================================================+
    | :ref:`Fortishield single node cluster<fortishield_server_multi_node_filebeat>`  | Install Filebeat on Fortishield single node cluster. |
    +---------------------------------------------------------------------+------------------------------------------------+
    | :ref:`Fortishield multi node cluster<fortishield_server_multi_node_filebeat>`   | Install Filebeat on Fortishield multi node cluster.  |
    +---------------------------------------------------------------------+------------------------------------------------+
    ...
    **Installing Splunk forwarder:**
    ...
    | Type                                                              | Description                                                                                                                            |
    +===================================================================+========================================================================================================================================+
    | `RPM/DEB packages <https://fortishield.github.io/documentation/3.13/installation-guide/installing-splunk/splunk-forwarder.html>`_                        | Install Splunk forwarder for RPM or DEB based OS.           |
    +-------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+


.. _deploy_fortishield_agents_cluster:
...
.. topic:: Pointing agents to the cluster nodes
    ...
    Execute the following command on the ``master node`` to verify that the Fortishield agents are correctly connected:
        ...
        .. code-block:: none
            ...
            Fortishield agent_control. List of available agents:
