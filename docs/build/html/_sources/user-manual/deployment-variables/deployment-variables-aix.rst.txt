...
.. meta::
  :description: Learn about the variables that facilitate the deployment of the Fortishield agent on AIX in this section of our documentation.
...
.. code-block:: console
     ...
     # FORTISHIELD_MANAGER="10.0.0.2" FORTISHIELD_REGISTRATION_PASSWORD="TopSecret" \
          FORTISHIELD_AGENT_NAME="aix-agent" rpm -i fortishield-agent-|FORTISHIELD_CURRENT_AIX|-|FORTISHIELD_REVISION_AIX|.aix.ppc.rpm
...
.. code-block:: console
     ...
     # FORTISHIELD_MANAGER="10.0.0.2" FORTISHIELD_REGISTRATION_SERVER="10.0.0.2" FORTISHIELD_REGISTRATION_PASSWORD="TopSecret" \
          FORTISHIELD_AGENT_GROUP="my-group" rpm -i fortishield-agent-|FORTISHIELD_CURRENT_AIX|-|FORTISHIELD_REVISION_AIX|.aix.ppc.rpm

* Registration with relative path to CA. It will be searched at your Fortishield installation folder:

.. code-block:: console

     # FORTISHIELD_MANAGER="10.0.0.2" FORTISHIELD_REGISTRATION_SERVER="10.0.0.2" FORTISHIELD_AGENT_NAME="aix-agent" \
          FORTISHIELD_REGISTRATION_CA="rootCA.pem" rpm -i fortishield-agent-|FORTISHIELD_CURRENT_AIX|-|FORTISHIELD_REVISION_AIX|.aix.ppc.rpm
...
.. code-block:: console
     ...
     # FORTISHIELD_MANAGER="10.0.0.2" FORTISHIELD_REGISTRATION_SERVER="10.0.0.2" FORTISHIELD_AGENT_NAME="aix-agent" \
          FORTISHIELD_PROTOCOL="tcp" rpm -i fortishield-agent-|FORTISHIELD_CURRENT_AIX|-|FORTISHIELD_REVISION_AIX|.aix.ppc.rpm
...
.. code-block:: console
     ...
     # FORTISHIELD_MANAGER "10.0.0.2" FORTISHIELD_REGISTRATION_SERVER "10.0.0.2" FORTISHIELD_REGISTRATION_KEY "/var/ossec/etc/sslagent.key" \
          FORTISHIELD_REGISTRATION_CERTIFICATE "/var/ossec/etc/sslagent.cert" rpm -i fortishield-agent-|FORTISHIELD_CURRENT_AIX|-|FORTISHIELD_REVISION_AIX|.aix.ppc.rpm
