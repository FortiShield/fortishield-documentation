...
.. meta::
  :description: Fortishield 3.11.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `fortishield/fortishield <https://github.com/fortishield/fortishield/blob/v3.11.0/CHANGELOG.md>`_
- `fortishield/fortishield-api <https://github.com/fortishield/fortishield-api/blob/v3.11.0/CHANGELOG.md>`_
- `fortishield/fortishield-ruleset <https://github.com/fortishield/fortishield-ruleset/blob/v3.11.0/CHANGELOG.md>`_
- `fortishield/fortishield-kibana-app <https://github.com/fortishield/fortishield-kibana-app/blob/v3.11.0-7.5.1/CHANGELOG.md>`_
- `fortishield/fortishield-splunk <https://github.com/fortishield/fortishield-splunk/tree/v3.11.0-8.0.0/CHANGELOG.md>`_
...
- The Fortishield agent now waits until the network service is ready before start.
...
Fortishield WUI for Kibana
---------------------
- Support for Kibana: v6.8.6, v7.5.1.
- Support for OpenDistro: v1.3.0.
- The API credentials configuration has been migrated from the ``.fortishield`` index to the ``fortishield.yml`` configuration file. Now the hosts API configuration is managed from this configuration file instead from the WUI.
- Reporting module events are now logged in the Fortishield WUI logs.
- The index pattern selector is now hidden in case that only one index exists.
- Fixed CSV export for files in a agents group.

Fortishield WUI for Splunk
---------------------
