...
.. meta::
  :description: Fortishield 3.12.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `fortishield/fortishield <https://github.com/fortishield/fortishield/blob/v3.12.0/CHANGELOG.md>`_
- `fortishield/fortishield-kibana-app <https://github.com/fortishield/fortishield-kibana-app/blob/3.12-7.6/CHANGELOG.md>`_
- `fortishield/fortishield-api <https://github.com/fortishield/fortishield-api/blob/3.12/CHANGELOG.md>`_
- `fortishield/fortishield-ruleset <https://github.com/fortishield/fortishield-ruleset/blob/3.12/CHANGELOG.md>`_
...
- Added a status validation when starting Fortishield.
...
- Restructuration of the `optimize/fortishield` directory.
