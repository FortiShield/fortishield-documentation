...
.. meta::
  :description: Check out Fortishield 3.x release notes. Every update of the solution is cumulative and includes all enhancements and fixes from previous releases.
  
3.x
===

This section summarizes the most important features of each Fortishield 3.x release.
