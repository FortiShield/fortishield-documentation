...
.. meta::
   :description: Learn how to install the Puppet server in this section of the Fortishield documentation. 
...
+----------------------------------------------------------------------------+-------------+
| The releases supported by the manifest to install Fortishield are as follows:                  |
+------------+---------+--------+---------+------+--------+---------+--------+-------------+
