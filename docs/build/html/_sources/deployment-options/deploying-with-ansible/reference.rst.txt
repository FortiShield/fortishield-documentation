...
.. meta::
  :Description: Ansible is an open source platform designed for automating tasks. Learn more about the variable references in this section of the Fortishield documentation.
  
Variables references
--------------------

.. _fortishield_ansible_reference_indexer:
...
.. _fortishield_ansible_reference_dashboard:
...
| **Description**: Listening IP address of the Fortishield dashboard.
| **Default value**: ``0.0.0.0``
|
| **Variable**: ``dashboard_server_port``
| **Description**: Listening port of the Fortishield dashboard.
| **Default value**: ``443``
|
| **Variable**: ``fortishield_version``
| **Description**: Fortishield APP compatible version to install.
| **Default value**: ``|FORTISHIELD_CURRENT_ANSIBLE|``
|

.. _fortishield_ansible_reference_filebeat:
...
.. _fortishield_ansible_reference_manager:

Fortishield Manager
=============

| **Variable**: ``fortishield_manager_fqdn``
| **Description**: Set Fortishield Manager fqdn hostname.
| **Default value**: ``fortishield-manager``
|
| **Variable**: ``fortishield_manager_config_overlay``
| **Description**: Indicates if the role(s) should perform a ``hash_behaviour=merge`` at role runtime, similar to role-distributed ansible.cfg. This provides support for a partially defined fortishield_manager_config while also moving on from the `deprecated hash_behaviour <https://docs.ansible.com/ansible/latest/reference_appendices/config.html#default-hash-behaviour>`_.
| **Default value**: ``true``
|
| **Variable**: ``fortishield_manager_json_output``
...
| **Default value**: ``yes``
|
| **Variable**: ``fortishield_manager_alerts_log``
...
| **Default value**: ``yes``
|
| **Variable**: ``fortishield_manager_logall``
...
| **Default value**: ``yes``
|
| **Variable**: ``fortishield_manager_email_notification``
...
| **Default value**: ``yes``
|
| **Variable**: ``fortishield_manager_mailto``
...
|
| **Variable**: ``fortishield_manager_globals``
...
|
| **Variable**: ``fortishield_manager_connection``
...
|
| **Variable**: ``fortishield_manager_reports``
...
|
| **Variable**: ``fortishield_manager_rootcheck``
...
|
| **Variable**: ``fortishield_manager_openscap``
...
|
| **Variable**: ``fortishield_manager_ciscat``
...
|
| **Variable**: ``fortishield_manager_osquery``
...
|
| **Variable**: ``fortishield_manager_syscollector``
...
|
| **Variable**: ``fortishield_manager_monitor_aws``
...
|
| **Variable**: ``fortishield_manager_sca``
...
|
| **Variable**: ``fortishield_manager_vulnerability_detector``
...
|
| **Variable**: ``fortishield_manager_syscheck``
...
|
| **Variable**: ``fortishield_manager_commands``
...
|
| **Variable**: ``fortishield_manager_localfiles``
...
|
| **Variable**: ``fortishield_manager_syslog_outputs``
...
|
| **Variable**: ``fortishield_manager_integrations``
...
|
| **Variable**: ``fortishield_manager_labels``
...
|
| **Variable**: ``fortishield_manager_ruleset``
...
|
| **Variable**: ``fortishield_manager_rule_exclude``
...
|
| **Variable**: ``fortishield_manager_authd``
...
|
| **Variable**: ``fortishield_manager_cluster``
...
|
| **Variable**: ``fortishield_manager_api``
| **Description**: Configures the :doc:`Fortishield API </user-manual/api/configuration>` file called ``api.yaml``.
| **Default values**:
...
|
| **Variable**: ``fortishield_api_user``
| **Description**: Fortishield API credentials.
| **Example**:
...
.. warning::
    ...
    We recommend the use of `Ansible Vault <https://docs.ansible.com/ansible/latest/user_guide/vault.html>`_ to protect Fortishield agentless and authd credentials.

|
| **Variable**: ``fortishield_manager_config``
| **Description**: Stores the Fortishield Manager configuration. This variable is provided for backward compatibility. Newer deployments should use the newly introduced variables described above.
| **Example**:
...
.. code-block:: yaml
    ...
    fortishield_manager_config:
      ...
      mail_from: fortishield-manager@example.com
      extra_emails:
        - enable: false
      ...
      commands:
        ...
        - name: 'restart-fortishield'
          executable: 'restart-fortishield'
          timeout_allowed: 'no'
        - name: 'win_restart-fortishield'
          executable: 'restart-fortishield.exe'
          timeout_allowed: 'no'
        - name: 'firewall-drop'
          executable: 'firewall-drop'
          timeout_allowed: 'yes'
        ...
        - name: 'win_route-null'
          ...
          timeout_allowed: 'yes'
      active_responses:
        - command: 'restart-fortishield'
          location: 'local'
          rules_id: '100002'
        - command: 'win_restart-fortishield'
          location: 'local'
          rules_id: '100003'
        - command: 'host-deny'
          location: 'local'
...
|
| **Variable**: ``fortishield_agent_configs``
| **Description**: This stores the different settings and profiles for centralized agent configuration via Fortishield Manager.
| **Example**:
...
|
| **Variable**: ``cdb_lists``
| **Description**: Configure CDB lists used by the Fortishield Manager.
| **Example**:
...
|
| **Variable**: ``authd_pass``
| **Description**: Fortishield authd service password.
| **Example**:
...
.. _fortishield_ansible_reference_agent:

Fortishield Agent
===========

| **Variable**: ``fortishield_managers``
| **Description**: Set the Fortishield Manager servers IP address, protocol, and port to be used by the agent. If a specific manager is used for registration, we can indicate which one it is by adding the register option set to true. If the register option is missing, the first manager on the list will be used for registration.
| **Example**:
...
|
| **Variable**: ``fortishield_agent_nolog_sensible``:
...
| **Default value**: ``yes``
|
| **Variable**: ``fortishield_agent_config_overlay``:
| **Description**: This variable apply an additional configuration combined with the default configuration.
| **Default value**: ``yes``
|
| **Variable**: ``fortishield_agent_api_validate``
| **Description**: After registering the agent through the REST API, validate that registration is correct.
| **Default value**: ``yes``
|
| **Variable**: ``fortishield_agent_address``
| **Description**: Establish which IP address we want to associate with this agent. It can be an address or “any” This variable will supersede fortishield_agent_nat.
| **Default value**: ``ansible_default_ipv4.address``
|
| **Variable**: ``fortishield_profile_centos``
...
.. code-block:: yaml
    ...
    fortishield_profile: "centos7, centos7"

|
| **Variable**: ``fortishield_profile_ubuntu``
...
.. code-block:: yaml
    ...
    fortishield_profile: "ubuntu, ubuntu18"
    
|
| **Variable**: ``fortishield_agent_authd``
| **Description**: Set the agent-authd facility. This will enable or not the automatic agent registration, you could set various options in accordance with the authd service configured in the Fortishield Manager. This Ansible role will use the address defined on ``registration_address`` as the authd registration server.
| **Example**:
...
|
| **Variable**: ``fortishield_auto_restart``
| **Description**: Set the ``<auto_restart>`` option in the agent.
| **Default value**: ``null``
|
| **Variable**: ``fortishield_notify_time``
| **Description**: Set the ``<notify_time>`` option in the agent.
| **Default value**: ``null``
|
| **Variable**: ``fortishield_crypto_method``
| **Description**: Set ``<crypto_method>`` option in the agent.
| **Default value**: ``null``
|
| **Variable**: ``fortishield_time_reconnect``
| **Description**: Set ``<time-reconnect>`` option in the agent.
| **Default value**: ``null``
|
| **Variable**: ``fortishield_winagent_config``
| **Description**: Set the Fortishield Agent installation regarding Windows hosts.
| **Example**:

.. code-block:: yaml

    fortishield_winagent_config:
      download_dir: C:\
...
|
| **Variable**: ``fortishield_agent_client_buffer``
...
.. code-block:: yaml
    ...
    fortishield_agent_client_buffer:
      disable: 'no'
      queue_size: '5000'
      events_per_sec: '500'

|
| **Variable**: ``fortishield_agent_rootcheck``
| **Description**: Configures the :doc:`rootcheck </user-manual/reference/ossec-conf/rootcheck>` section from agent ``ossec.conf``.
| **Example**:

.. code-block:: yaml

    fortishield_agent_rootcheck:
      frequency: 43200

|
| **Variable**: ``fortishield_agent_openscap``
| **Description**: Configures the :doc:`wodle </user-manual/reference/ossec-conf/wodle-openscap>` item named ``open-scap`` from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    fortishield_agent_openscap:
      disable: 'yes'
      timeout: 1800
      interval: '1d'
      scan_on_start: 'yes'
...
|
| **Variable**: ``fortishield_agent_cis_cat``
| **Description**: Configures the :doc:`wodle </user-manual/reference/ossec-conf/wodle-ciscat>` item named ``cis-cat`` from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    fortishield_agent_cis_cat:
      disable: 'yes'
      install_java: 'no'
      timeout: 1800
      interval: '1d'
...
|
| **Variable**: ``fortishield_agent_osquery``
| **Description**: Configures the :doc:`wodle</user-manual/reference/ossec-conf/wodle-osquery>` item named ``osquery`` from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    fortishield_agent_osquery:
      disable: 'yes'
      run_daemon: 'yes'
...
|
| **Variable**: ``fortishield_agent_syscollector``
| **Description**: Configures the :doc:`wodle </user-manual/reference/ossec-conf/wodle-syscollector>` item named ``syscollector`` from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    fortishield_agent_syscollector:
      disable: 'no'
      interval: '1h'
      scan_on_start: 'yes'
      hardware: 'yes'
...
|
| **Variable**: ``fortishield_agent_sca``
| **Description**: Configures the :doc:`sca </user-manual/reference/ossec-conf/sca>` section from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    fortishield_agent_sca:
      enabled: 'yes'
      scan_on_start: 'yes'
      interval: '12h'
      skip_nfs: 'yes'
...
|
| **Variable**: ``fortishield_agent_syscheck``
| **Description**: Configures the :doc:`syscheck </user-manual/reference/ossec-conf/syscheck>` section from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    fortishield_agent_syscheck:
      frequency: 43200
      scan_on_start: 'yes'
      auto_ignore: 'no'
...
|
| **Variable**: ``fortishield_agent_labels``
| **Description**: Configures the :doc:`labels </user-manual/reference/ossec-conf/labels>` section from ``ossec.conf``.
| **Default values**:

.. code-block:: yaml

    fortishield_agent_labels:
      enable: false
      list:
        - key: Env
          value: Production
...
|
| **Variable**: ``fortishield_agent_log_format``
| **Description**: Configures the :doc:`log_format </user-manual/reference/ossec-conf/logging>` section from ``ossec.conf``.
| **Default value**: ``plain``
|
| **Variable**: ``fortishield_agent_config_defaults``
| **Description**: Fortishield Agent related configuration. This variable is provided for backward compatibility. Newer deployments should use the newly introduced variables described above.
| **Example**:

.. code-block:: yaml

    fortishield_agent_config_defaults:
      repo: '{{ fortishield_repo }}'
      active_response: '{{ fortishield_agent_active_response }}'
      log_format: '{{ fortishield_agent_log_format }}'
      client_buffer: '{{ fortishield_agent_client_buffer }}'
      syscheck: '{{ fortishield_agent_syscheck }}'

      rootcheck: '{{ fortishield_agent_rootcheck }}'
      openscap: '{{ fortishield_agent_openscap }}'

      osquery: '{{ fortishield_agent_osquery }}'
      syscollector: '{{ fortishield_agent_syscollector }}'
      sca: '{{ fortishield_agent_sca }}'
      cis_cat: '{{ fortishield_agent_cis_cat }}'
      localfiles: '{{ fortishield_agent_localfiles }}'

      labels: '{{ fortishield_agent_labels }}'
      enrollment: '{{ fortishield_agent_enrollment }}'
...
| **Variable**: ``authd_pass``
| **Description**: Fortishield authd credentials for agent registration.
| **Example**:
