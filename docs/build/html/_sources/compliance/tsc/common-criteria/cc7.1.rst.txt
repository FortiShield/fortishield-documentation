...
.. meta::
   :description: Fortishield helps meet the common criteria CC7.1 by providing the Vulnerability Detection module.
...
#. If you made changes, restart the Fortishield manager to apply them:

   .. include:: /_templates/common/restart_manager.rst

#. Navigate to the **Vulnerability detection** module from the Fortishield dashboard. Select the agent to view its discovered vulnerabilities.
