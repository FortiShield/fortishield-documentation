...
.. meta::
  :description: Discover how Fortishield helps you monitor the Office 365 audit log for your organization. Learn more about it in this section of our documentation.
  
.. _office365:

Using Fortishield to monitor Office 365
=================================

This section provides instructions for monitoring the Office 365 `audit log` for your organization.

The `audit log` allows Fortishield to monitor:
