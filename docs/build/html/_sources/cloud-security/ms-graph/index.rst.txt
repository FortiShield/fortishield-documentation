...
.. meta::
  :description: Discover how Fortishield helps you monitor the Microsoft Graph API for your organization. Learn more about it in this section of our documentation.
  
.. _ms-graph:

Using Fortishield to monitor Microsoft Graph
======================================
...
Currently, the module allows you to monitor the following with Fortishield:
