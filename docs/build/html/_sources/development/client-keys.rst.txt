...
.. meta::
   :description: The client.keys file stores the data used to authenticate secure agents. For more information, check this section of the Fortishield documentation.
