...
project = u'Fortishield'
author = u'Fortishield, Inc.'
copyright = u'&copy; ' + str(datetime.datetime.now().year) + u' Fortishield Inc.'
...
extensions = [
    ...
    'sphinx_tabs.tabs',
    'fortishield-doc-images', # Custom extension
    'sphinx_reredirects'
]
...
html_theme = 'fortishield_doc_theme_v3'
...
html_theme_options = {
    ...
    'fortishield_doc_url': 'https://fortishield.github.io/documentation',
...
# of the sidebar.
html_logo = theme_assets_path + '/static/images/fortishield-logo.png'
...
htmlhelp_basename = 'FortishieldDocs'
...
latex_documents = [
    (master_doc, 'FortishieldDocs.tex', u'Documentation', u'Fortishield, Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'fortishielddocs', u'Documentation', [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FortishieldDocs', u'Documentation', author, 'Fortishield', 'Documentation', 'Miscellaneous'),
]
...
def manage_assets(app, pagename, templatename, context, doctree):
    ...
    individual_js_files = {
        ...
        "fortishield-documentation": static + "js/min/fortishield-documentation.min.js?ver=%s" % os.stat(os.path.join(theme_dir, "static/js/min/fortishield-documentation.min.js")).st_mtime,
    ...
    def get_css_by_page(pagename):
        ...
        default = "css/min/fortishield-documentation.min.css?ver=%s" % os.stat(os.path.join(theme_dir, "static/css/min/fortishield-documentation.min.css")).st_mtime
    ...
    def get_js_by_page(pagename):
        ...
        default = [
            individual_js_files['redirects'],
            individual_js_files['fortishield-documentation']
            # tabs (extension)
            # lightbox (extension)
        ]
...
def creating_file_list(app, exception):
    ...
    if app.builder.name == 'html':
        ...
        for compiled_html in list_compiled_html:
            sitemap += '\t<url><loc>' + requote_uri(html_theme_options.get('fortishield_doc_url') + '/' + sitemap_version + '/' + compiled_html) + '</loc></url>' + separator
...
html_context = {
    "display_github": True,
    "github_user": "fortishield",
    "github_repo": "fortishield-documentation",
    "conf_py_path": "/source/",
