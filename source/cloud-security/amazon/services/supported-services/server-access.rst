...
.. meta::
  :description: AWS Server Access Logging is a service that provides detailed records for the requests made to a bucket. Learn how to configure and monitor it with Fortishield.
    ...
    .. code-block:: xml
      ...
      <wodle name="aws-s3">
        ...
        <bucket type="server_access">
          <name>fortishield-aws-wodle</name>       <!-- PUT HERE THE S3 BUCKET CHOSEN IN STEP 5 -->
