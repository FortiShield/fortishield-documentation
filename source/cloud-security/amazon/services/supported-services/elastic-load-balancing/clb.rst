...
.. meta::
  :description: AWS Classic Load Balancer is a service that distributes incoming application traffic across multiple targets. Learn how to configure and monitor it with Fortishield.
...
#. Open the Fortishield configuration file (``/var/ossec/etc/ossec.conf``) and add the following block for CLB:
