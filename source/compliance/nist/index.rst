...
In the `Fortishield for NIST 800-53 revision 5 guide (PDF) <https://fortishield.com/resources/Fortishield-NIST-800-53-guide.pdf>`_, we explain how the various Fortishield modules assist in meeting and implementing NIST 800-53 controls.
