...
.. meta::
  :description: Fortishield 2.1 has been released. Check out our release notes to discover the changes and additions of this release.
...
This section shows the most relevant new features of Fortishield v2.1. You will find more detailed information in our `changelog <https://github.com/fortishield/fortishield/blob/v2.1.0/CHANGELOG.md>`_ file.
...
Learn more about this new mechanism at :doc:`Anti-flooding mechanism <../user-manual/agents/antiflooding>`.
...
For more details about this new feature see our :doc:`Labels section <../user-manual/agents/labels>`.

Improved Authd performance
--------------------------

The Authd program has been improved in this version such that the Fortishield API and the ``manage_agents`` tools can now register an agent while ``ossec-authd`` is running.
...
External libraries used by Fortishield have been updated to improve their integration with our components.
