...
.. meta::
  :description: Check out all the Fortishield release notes. Every update of the solution is cumulative and includes all enhancements and fixes from previous releases.

Release notes
=============

This section summarizes the most important features of each Fortishield release.
