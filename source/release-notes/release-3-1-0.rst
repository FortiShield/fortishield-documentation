...
.. meta::
  :description: Fortishield 3.1.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
This section shows the most relevant new features of Fortishield v3.1.0. You will find more detailed information in our `changelog <https://github.com/fortishield/fortishield/blob/v3.1.0/CHANGELOG.md>`_ file.

**New features:**

- `VULS integration`_
- `CIS-CAT Fortishield module to scan CIS policies`_
- `New "Command" Fortishield module`_
...
.. code-block:: none
   ...
   ** Alert 1513880084.806869: - vuls,
   2017 Dec 21 18:14:44 ip-172-31-42-67->Fortishield-VULS
...
The new CIS-CAT module was developed for evaluating CIS benchmarks in Fortishield agents. This module assesses an agent's compliance with CIS policies to ensure the application of the best practices in in the security of your IT systems.
...
New "Command" Fortishield module
--------------------------
...
In large environments, the alerts file may take up a large amount of disk space. To address this, Fortishield 3.1 includes support for rotating the following files by time or size:
...
The Fortishield API has been enhanced with new requests, such as:
...
In addition, more new features can be found in the `API changelog <https://github.com/fortishield/fortishield-api/blob/3.1/CHANGELOG.md>`_.
...
More information on changes to the Ruleset can be found on the `Ruleset changelog <https://github.com/fortishield/fortishield-ruleset/blob/3.1/CHANGELOG.md>`_.


More relevant features
----------------------

Additional features have been added to Fortishield 3.1.0 in order to improve its performance, including, but not limited to:
