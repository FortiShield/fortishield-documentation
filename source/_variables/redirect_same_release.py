...
redirectSameRelease = {
  ...
  '4.4': {
    ...
    '/user-manual/capabilities/fortishield-archives.html':
  ...
  '4.3': {
   '/user-manual/fortishield-dashboard/single-sign-on/index.html':
     '/user-manual/user-administration/single-sign-on/index.html',
   '/user-manual/fortishield-dashboard/single-sign-on/okta.html':
     '/user-manual/user-administration/single-sign-on/administrator/okta.html',
   '/user-manual/fortishield-dashboard/single-sign-on/azure-active-directory.html':
     '/user-manual/user-administration/single-sign-on/administrator/azure-active-directory.html',
   '/user-manual/fortishield-dashboard/single-sign-on/pingone.html':
     '/user-manual/user-administration/single-sign-on/administrator/pingone.html',
   '/user-manual/fortishield-dashboard/single-sign-on/google.html':
     '/user-manual/user-administration/single-sign-on/administrator/google.html',
   '/user-manual/fortishield-dashboard/single-sign-on/jumpcloud.html':
     '/user-manual/user-administration/single-sign-on/administrator/jumpcloud.html',
   '/user-manual/fortishield-dashboard/single-sign-on/onelogin.html':
   ...
   '/user-manual/securing-fortishield/index.html':
     '/user-manual/user-administration/password-management.html',
   '/user-manual/securing-fortishield/fortishield-indexer.html':
     '/user-manual/user-administration/password-management.html',
   '/user-manual/securing-fortishield/opendistro.html':
     '/user-manual/user-administration/password-management.html',
   '/user-manual/securing-fortishield/elastic-stack.html':  
     '/user-manual/user-administration/password-management.html',
   '/user-manual/fortishield-dashboard/rbac.html':
     '/user-manual/user-administration/rbac.html', 
   '/learning-fortishield/build-lab/install-fortishield-central-components.html':
