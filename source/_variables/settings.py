...
# * apiURL: URL of the Fortishield API reference spec in the Wazih repository (public)
...
apiURL = 'https://raw.githubusercontent.com/fortishield/fortishield/'+api_tag+'/api/api/spec/spec.yaml'
