...
.. meta::
  :description: Find out more about key request, the Fortishield feature that allows you to fetch keys stored in an external database.
...
.. note::
  Keep in mind that the above examples represent how Fortishield will call your program.
