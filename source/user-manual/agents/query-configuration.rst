...
.. meta::
  :description: The actual configuration of an agent or the manager can be queried on demand. Learn more about it in this section of the Fortishield documentation.
...
.. thumbnail:: ../../images/kibana-app/features/query-configuration/configuration-section.png
  :title: Query the manager configuration in Fortishield dashboard
  :alt: Query the manager configuration in Fortishield dashboard
  :align: center
  :width: 100%
...
Now for example, if you want to know the current cluster configuration from one of your *Fortishield managers*, click on the upper-left menu icon **☰** to open the options, go to **Server management** > **Settings** module, select the desired node and then click on the **Cluster** section:
