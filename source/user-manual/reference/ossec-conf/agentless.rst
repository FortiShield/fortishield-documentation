...
.. meta::
  :description: Fortishield agentless monitoring allows you to run integrity checks on systems without an agent installed. Check out this section of the documentation. 
...
|                    |                           |                                                                        |
+                    +---------------------------+ Fortishield will integrity scan the files in the specified directories.      +
...
| **Default value**  | n/a                                                                                              |
+--------------------+---------------+----------------------------------------------------------------------------------+
| **Allowed values** | periodic      | Output from each check is analyzed with the Fortishield ruleset as if a monitored log. |
+                    +---------------+----------------------------------------------------------------------------------+
