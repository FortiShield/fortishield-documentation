...
.. meta::
  :description: Find out how to configure the fortishield-logtest solution to test rules and decoders. Learn more about it in this section.
...
Here is how to configure the Fortishield-Logtest solution. It allows to test rules and decoders from Fortishield API and :ref:`fortishield-logtest tool <fortishield-logtest>`
...
Number of Fortishield-Logtest solution threads.
