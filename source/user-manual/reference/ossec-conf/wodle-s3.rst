...
.. meta::
    :description: Learn more about the local configuration of Fortishield. In this section of the documentation you can learn more about the configuration options of the Fortishield integration with AWS.
...
Run the module immediately after the Fortishield service starts.
