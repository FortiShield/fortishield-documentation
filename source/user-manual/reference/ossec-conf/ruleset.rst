...
.. meta::
  :description: Find out more about the configuration options for enabling or disabling rules and decoders with Fortishield.
...
.. note::
    ...
    Do not include the file extension. Since Fortishield v3.11.0, Fortishield will build and load the CDB lists automatically when the analysis engine starts.
