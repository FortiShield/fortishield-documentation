...
.. meta::
  :description: Migrate FIM databases older than Fortishield v3.7.0 to the new format included in Fortishield-DB using the fim_migrate tool. Learn more about it in this section.
...
The *fim_migrate* tool allows to migrate FIM databases older than Fortishield v3.7.0 to the new format included in Fortishield-DB. This tool must be executed after the :ref:`upgrading process <upgrading_fortishield_server>` has been completed.
...
This tool is not included in the Fortishield installation, but you can download it from the Fortishield repository on GitHub:

.. code-block:: console

    # curl -so fim_migrate https://raw.githubusercontent.com/fortishield/fortishield/v|FORTISHIELD_CURRENT|/tools/migration/fim_migrate.py
