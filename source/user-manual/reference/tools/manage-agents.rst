...
.. meta::
  :description: The manage_agents program is available in both versions for server and agent installations. Learn more about it in this section of the Fortishield documentation.
...
keys for Fortishield agents. These authentication keys are required for secure (encrypted and
authenticated) communication between the Fortishield server and its affiliated agent instances.
