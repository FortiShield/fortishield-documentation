...
.. meta::
  :description: The fortishield-agentd.state file provides information about the agent. Learn more about it in this section of the Fortishield documentation.

.. _fortishield_agentd_state_file:

fortishield-agentd.state
==================

The statistical file for **fortishield-agentd** is located at ``/var/ossec/var/run/fortishield-agentd.state``.
...
.. code-block:: pkgconfig
    ...
    # State file for fortishield-agentd
