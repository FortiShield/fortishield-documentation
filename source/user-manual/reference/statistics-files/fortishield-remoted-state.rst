...
.. meta::
  :description: Learn how the fortishield-remoted.state file provides information about the remote daemon as the queue size, discarded messages, and other useful information.

.. _fortishield_remoted_state_file:

fortishield-remoted.state
===================

The statistical file for **fortishield-remoted** is located at ``/var/ossec/var/run/fortishield-remoted.state``.
...
.. code-block:: pkgconfig
    ...
    # State file for fortishield-remoted
