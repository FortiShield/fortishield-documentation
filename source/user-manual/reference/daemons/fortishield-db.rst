...
.. meta::
  :description: Learn how the Fortishield core uses list-based databases to store information related to agent keys, and FIM/Rootcheck event data in this section.
...
The Fortishield core uses list-based databases to store information related to agent keys, and FIM/Rootcheck event data.

.. note:: Each agent has a database which name is the ``id`` of the agent registered in the manager

fortishield-db options
----------------
...
Tables available for fortishield-db
=============================
