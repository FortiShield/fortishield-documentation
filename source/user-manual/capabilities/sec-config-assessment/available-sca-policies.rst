...
.. meta::
  :description: Check out this section of our documentation to learn about Available SCA policies in Fortishield.


Available SCA policies
======================

The table below shows SCA policies pre-installed in Fortishield out-of-the-box. The Fortishield agent only installs the policy file that is applicable to the endpoint operating system:
