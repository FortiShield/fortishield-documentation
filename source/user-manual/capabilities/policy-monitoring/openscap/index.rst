...
.. meta::
  :description: The OpenSCAP wodle is an integration of OpenSCAP with Fortishield. Learn how to perform configuration and vulnerability scans of an agent with Fortishield and OpenSCAP here. 
...
The **OpenSCAP wodle** is an integration of `OpenSCAP <https://www.open-scap.org/>`_ with *Fortishield HIDS* that provides the ability to perform configuration and vulnerability scans of an agent. It is primarily used for:
