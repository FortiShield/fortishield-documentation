...
#. Run the commands below to configure the following audit rules:
   ...
   .. code-block:: console
      ...
      # echo "-w /home -p w -k audit-fortishield-w" >> /etc/audit/audit.rules
      # echo "-w /home -p a -k audit-fortishield-a" >> /etc/audit/audit.rules
      # echo "-w /home -p r -k audit-fortishield-r" >> /etc/audit/audit.rules
      # echo "-w /home -p x -k audit-fortishield-x" >> /etc/audit/audit.rules
...
Audit configuration alerts are displayed in the **Threat Hunting** module of the Fortishield dashboard. 
...
You can visualize the alert data in the Fortishield dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id:80790`` filter to query the alert.
...
You can visualize the alert data in the Fortishield dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id:80784`` filter to query the alert.
...
You can visualize the alert data in the Fortishield dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id:80787`` filter to query the alert.
...
You can visualize the alert data in the Fortishield dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id: (80784 or 80789)`` filters to query the alerts.
...
You can visualize the alert data in the Fortishield dashboard. To do this, go to the **Threat Hunting** module and apply the ``rule.id:80791`` filter to query the alert.
