...
.. meta::
  :description: Fortishield supports more than 3000 rules that accomplish a variety of technologies. Check them out here. 
...
Currently, Fortishield supports more than 3k rules that accomplish technologies such:
...
In the Fortishield repository you will find:
...
Inside the ``ruleset/`` folder you will find all the common rules and decoders. All files inside this folder **will be overwritten** or modified in the Fortishield update process, so please do not edit files or add custom files in this folder.
