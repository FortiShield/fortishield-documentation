...
.. |logtest| replace:: `/logtest <https://fortishield.github.io/documentation/|FORTISHIELD_CURRENT_MINOR|/user-manual/api/reference.html#operation/api.controllers.logtest_controller.run_logtest_tool>`__

.. |logtest_sessions| replace:: `/logtest/sessions/{token} <https://fortishield.github.io/documentation/|FORTISHIELD_CURRENT_MINOR|/user-manual/api/reference.html#operation/api.controllers.logtest_controller.end_logtest_session>`__
