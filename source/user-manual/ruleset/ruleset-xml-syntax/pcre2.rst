...
.. meta::
  :description: The Fortishield Ruleset is used to analyze incoming events and generate alerts when appropriate. Learn more about Perl-compatible regular expressions here.
...
Log collecting and processing is one of the most important features in Fortishield,
allowing users to know the status in real-time of the Fortishield agent operating system and
...
fortishield-logtest output show the triggered alert
