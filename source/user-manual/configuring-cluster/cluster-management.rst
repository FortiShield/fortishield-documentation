...
.. meta::
  :description: The cluster_control tool allows you to get real-time information about the health of the cluster. Learn more about deploying a Fortishield cluster in this section.

Cluster management
===================

The **cluster_control** tool allows you to obtain real-time information about the cluster health, connected nodes, and the agents reporting to the cluster. This information can also be obtained using the Fortishield API :api-ref:`cluster endpoints <tag/Cluster>`.
...
This information can also be obtained using the Fortishield API endpoint :api-ref:`GET /cluster/nodes <operation/api.controllers.cluster_controller.get_cluster_nodes>`:
