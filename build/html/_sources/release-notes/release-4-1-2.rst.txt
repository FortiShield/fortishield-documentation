...
.. meta::
  :description: Fortishield 4.1.2 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `fortishield/fortishield <https://github.com/fortishield/fortishield/blob/v4.1.2/CHANGELOG.md>`_
...
- Issue with overlay of Fortishield menu when Kibana menu is opened or docked is now fixed.
