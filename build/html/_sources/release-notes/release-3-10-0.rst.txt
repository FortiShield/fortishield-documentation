...
.. meta::
  :description: Fortishield 3.10.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `fortishield/fortishield <https://github.com/fortishield/fortishield/blob/v3.10.0/CHANGELOG.md>`_
- `fortishield/fortishield-api <https://github.com/fortishield/fortishield-api/blob/v3.10.0/CHANGELOG.md>`_
- `fortishield/fortishield-ruleset <https://github.com/fortishield/fortishield-ruleset/blob/v3.10.0/CHANGELOG.md>`_
- `fortishield/fortishield-kibana-app <https://github.com/fortishield/fortishield-kibana-app/blob/v3.10.0-7.3.2/CHANGELOG.md>`_
- `fortishield/fortishield-splunk <https://github.com/fortishield/fortishield-splunk/blob/v3.10.0-7.3.0/CHANGELOG.md>`_
...
- New corresponding fields in the Fortishield Elastic Stack template.
...
.. thumbnail:: ../images/release-notes/3.10.0/HIPAA.png
  :title: Fortishield App HIPAA Dashboard
  :align: center
  :width: 100%

.. thumbnail:: ../images/release-notes/3.10.0/NIST.png
  :title: Fortishield App NIST Dashboard
  :align: center
  :width: 100%
  ...
  .. code-block:: js
      ...
      "data": {
          ...
          "agent_version": {
              "items": [
                  {
                  "version": "Fortishield v3.10.0",
                  "count": 1
                  },
                  {
                  "version": "Fortishield v3.9.5",
                  "count": 5
                  }
              ],
              "totalItems": 6
...
- Fortishield Kibana app now works as a native plugin and can be safely hidden/displayed depending on the selected space.
...
- Fortishield Splunk app has been adapted for Microsoft Edge Browser.
...
- Export all the information of a Fortishield group and its related agents in a PDF document.
