...
.. meta::
  :description: Fortishield 3.5.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `fortishield/fortishield <https://github.com/fortishield/fortishield/blob/v3.5.0/CHANGELOG.md>`_
- `fortishield/fortishield-api <https://github.com/fortishield/fortishield-api/blob/v3.5.0/CHANGELOG.md>`_
- `fortishield/fortishield-ruleset <https://github.com/fortishield/fortishield-ruleset/blob/v3.5.0/CHANGELOG.md>`_
- `fortishield/fortishield-kibana-app <https://github.com/fortishield/fortishield-kibana-app/blob/v3.5.0-6.3.2/CHANGELOG.md>`_
- `fortishield/fortishield-kibana-splunk <https://github.com/fortishield/fortishield-splunk/blob/v3.5.0-7.1.2/CHANGELOG.md>`_
...
- Added new tab on Configuration to show the current Fortishield app configuration file values.
- Added new tab on Configuration to show the latest Fortishield app logs.
...
In addition to this, the documentation now has a dedicated section for the Fortishield app, where you can learn more about its capabilities, how to configure it and install the X-Pack Security plugin.
