...
.. meta::
  :description: Fortishield 3.2.1 has been released. Check out our release notes to discover the changes and additions of this release.
...
This release is a bug fix release. This section shows the most relevant improvements and fixes of Fortishield v3.2.1. You will find more detailed information in the `changelog <https://github.com/fortishield/fortishield/blob/v3.2.1/CHANGELOG.md#v321>`_ file.

- `Fortishield modules`_
- `Cluster`_
- `Agents management`_
- `OpenSSL library`_
...
The Fortishield modules include several fixes in this release to improve their performance and reliability. The most relevant changes are described in this section.

To avoid the agent flooding, a maximum of events sent per second has been established for every module.
This limit is configurable by the ``fortishield_modules.max_eps`` parameter of the internal configuration.
...
Cluster
-------
Several bugs have been fixed in the Fortishield cluster, among them, dealing with too long file paths.
