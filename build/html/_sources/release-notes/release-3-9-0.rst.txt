...
.. meta::
  :description: Fortishield 3.9.0 has been released. Check out our release notes to discover the changes and additions of this release.
...
- `fortishield/fortishield <https://github.com/fortishield/fortishield/blob/v3.9.0/CHANGELOG.md>`_
- `fortishield/fortishield-api <https://github.com/fortishield/fortishield-api/blob/v3.9.0/CHANGELOG.md>`_
- `fortishield/fortishield-ruleset <https://github.com/fortishield/fortishield-ruleset/blob/v3.9.0/CHANGELOG.md>`_
- `fortishield/fortishield-kibana-app <https://github.com/fortishield/fortishield-kibana-app/blob/3.9-6.7/CHANGELOG.md>`_
- `fortishield/fortishield-splunk <https://github.com/fortishield/fortishield-splunk/blob/3.9/CHANGELOG.md>`_
...
.. code-block:: console
    ...
    $ FORTISHIELD_MANAGER_IP="10.0.0.2" yum install fortishield-agent
...
Security Configuration Assessment (SCA) is a new module created to improve hardening and policy monitoring capabilities in Fortishield. Policy files are now in YAML format, making easier modifications and reading. Policies have been extended, useful compliance information has been added to each policy (rationale, remediation, CSC, etc.). Scan results are sent and stored in Manager side, being accessible using both the Fortishield API and the Fortishield app.
...
.. code-block:: xml
    ...
    <wodle name="aws-s3">
        ...
        <bucket type="cloudtrail">
            ...
            <aws_organization_id>fortishield</aws_organization_id>
...
- The Fortishield manager no longer has any external dependencies on Python. The manager now includes its own embedded Python 3 interpreter. Making easier to configure integrations as AWS, VirusTotal, Azure or Slack.
...
Added *-t* and *-c* options for the Fortishield cluster daemon. Those options allow the user to test an isolated configuration file or to test the existing one configuration file.
...
- Fortishield manager starts regardless of the contents of ``local_decoder.xml``.
...
**Fortishield manager configuration editor**
...
.. thumbnail:: ../images/release-notes/3.9.0/app-configuration-editor.png
  :title: Fortishield manager configuration editor
  :align: center
  :width: 100%
...
Thanks to the recently added Fortishield API endpoints, the app comes with multiple improvements for the ruleset section, including rules, decoders and CDB list management.
...
- Added support for more than one Fortishield monitoring pattern.
