...
.. meta::
  :description: You can generate two types of reports from the Fortishield dashboard. Learn more about it in this section of the Fortishield documentation. 

Generating system inventory reports
===================================

You can generate two types of reports from the Fortishield dashboard. These reports are the property-specific report and the endpoint inventory report. 
...
This feature allows you to export a full report of all endpoint properties collected by the Fortishield Syscollector module. This report is generated in PDF format and can serve a variety of uses. To download the full endpoint report:

- Click on **Generate Report** on the **Inventory data** page of the Fortishield agent.
