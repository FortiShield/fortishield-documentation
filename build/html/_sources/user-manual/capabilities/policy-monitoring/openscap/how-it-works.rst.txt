...
.. meta::
  :description: Learn more about how the Security Content Automation Protocol (SCAP) works and its requirements in this section of the Fortishield documentation.
...
These are the Security Policy included by default on Fortishield:
