...
.. meta::
   :description: This guide will teach you about monitoring system calls with Fortishield: control rules, file system rules, and system call rules. 
...
|                      |                                                                                                                                                                 |
|                      | Fortishield requires this argument to analyze the logs more accurately.                                                                                               |
+----------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+
