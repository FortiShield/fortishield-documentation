...
.. meta::
  :description: Learn more about how to create custom Security Configuration Assessment (SCA) policies in Fortishield and discover some examples. 
...
<https://github.com/fortishield/fortishield-qa/tree/master/tests/legacy/test_sca/test_basic_usage/data>`_.
