...
.. meta::
  :description: The Fortishield manager can be configured to publish the remote service. Check out this section of our documentation to learn more about this. 
...
The Fortishield manager can be configured to publish the remote service used by agents as follows:
