...
.. meta::
  :description: The fortishield-analysisd.state file can be useful when benchmarking our Fortishield manager analysis engine in highly loaded environments. Learn more about it here.

.. _fortishield_analysisd_state_file:

fortishield-analysisd.state
=====================

The statistical file for **fortishield-analysisd** is located at ``/var/ossec/var/run/fortishield-analysisd.state``.

It can be useful when benchmarking our Fortishield manager analysis engine in highly loaded environments.
...
.. code-block:: pkgconfig
    ...
    # State file for fortishield-analysisd
