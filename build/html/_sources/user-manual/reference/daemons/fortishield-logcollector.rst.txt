...
.. meta::
  :description: Learn about the fortishield-logcollector program that monitors configured files and commands for new log messages in this section of the documentation.

.. _fortishield-logcollector:

fortishield-logcollector
==================

The fortishield-logcollector program monitors configured files and commands for new log messages.

``fortishield-logcollector`` is now multi-threaded, achieving an improvement in overall performance. Each of the threads will read the first log that is not already handled by other threads
