...
.. meta::
  :description: Learn how the ``fortishield-analysisd`` program receives the log messages and compares them to the rules in this section of the documentation.

.. _fortishield-analysisd:

fortishield-analysisd
===============

The ``fortishield-analysisd`` program receives the log messages and compares them to the rules. It then creates an alert when a log message matches an applicable rule.
...
.. _fortishield-analysisd-structure:
