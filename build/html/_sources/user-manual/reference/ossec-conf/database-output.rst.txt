...
.. meta::
  :description: Find out how to configure the Fortishield database_output feature. Learn more about it in this section of the Fortishield documentation.
...
.. note::
  To use this output feature, Fortishield must be compiled with the database type that is to be used. Read :ref:`this article <manual_database_output>` to learn about how to install and enable it.
