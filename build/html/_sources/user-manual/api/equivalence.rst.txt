...
The Fortishield API users are not migrated when upgrading the Fortishield API from 3.X to 4.X and newer versions. It is not recommended to migrate the users since there are numerous security changes to the Fortishield API.
...
.. code-block:: json
...

    {
      ...
      "message": "All roles were linked to user <fortishield>",
      "error": 0
    }
