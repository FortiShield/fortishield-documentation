...
+-----------------+-----------------------------------------+
| **Example**     | decoder:file:0005-fortishield_decoders.xml    |
+-----------------+-----------------------------------------+
...
.. warning::
    ...
    Run_as permissions through these mapping rules can only be obtained with ``fortishield-wui`` user. These rules will never match an authorization context for any other Fortishield API user.
