...
.. meta::
  :description: Learn how to remove agents using the command line interface (CLI) in Fortishield in this section of the Fortishield documentation.
...
.. code-block:: none
    ...
    ****************************************
    * Fortishield v|FORTISHIELD_CURRENT| Agent manager.          *
