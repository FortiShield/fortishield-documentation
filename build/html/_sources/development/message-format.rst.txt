...
.. meta::
  :description: This section contains instructions to describe the Standard OSSEC message format Fortishield accepts and sends between its components.
...
This page aims to describe the format of messages that OSSEC (and Fortishield) accepts and sends between its components:
