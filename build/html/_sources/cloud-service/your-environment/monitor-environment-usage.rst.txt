...
.. meta::
  :description: Check out how to monitor your environment usage in Fortishield Cloud. Learn more about it in this section of the documentation.
...
The ``agents`` metric shows the number of Fortishield agents in the ``active``, ``disconnected``, ``never connected``, and ``pending`` states. It also displays the limit of active agents, which is configurable through the :ref:`active agents <cloud_settings_active_agents>` setting.
