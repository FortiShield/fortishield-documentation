...
.. meta::
   :description: Learn about the Fortishield agent class and its variables to configure the Fortishield agent in this section of the Fortishield documentation. 

.. _reference_fortishield_agent_class:

Fortishield agent class
=================

``class fortishield::agent``
----------------------

This contains variables that can be used to configure the Fortishield agent.
...
$fortishield_enrollment_enabled
...
$fortishield_enrollment_manager_address
...
$fortishield_enrollment_port
  ...
  `Type String`
   ...
   Depends on **fortishield_enrollment_enabled**

$fortishield_enrollment_agent_name
...
$fortishield_enrollment_agent_address
...
$fortishield_enrollment_ssl_cipher
...
$fortishield_enrollment_server_ca_path
...
$fortishield_enrollment_agent_cert_path
...
$fortishield_enrollment_agent_key_path
  Required when agent verification is enabled in the manager.
...
$fortishield_enrollment_auth_pass
  Enrollment password.
...
$fortishield_enrollment_auth_pass_path
...
$fortishield_enrollment_auto_method
...
$fortishield_delay_after_enrollment
...
$fortishield_enrollment_use_source_ip
...
$fortishield_reporting_endpoint
  Specifies the IP address or the hostname of the Fortishield manager to report.

  `Default undef`

  `Type String`
  
$fortishield_register_endpoint
  Specifies the IP address or the hostname of the Fortishield manager to register against. It is used to run the **agent-auth** tool.

  `Type String`

$ossec_port
  Specifies the port to send events to the manager. This must match the associated listening port configured on the Fortishield manager.
