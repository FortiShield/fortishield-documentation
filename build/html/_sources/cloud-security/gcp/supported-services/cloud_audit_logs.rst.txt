...
.. meta::
  :description: The Fortishield GCP Pub/Sub module allows you to fetch logs from Google Audit Logs. Learn more about the module's usage in this section.
...
Fortishield can collect and analyze these log types using the :ref:`GCP Pub/Sub integration <pubsub>`.
...
After configuring the GCP Pub/Sub module to fetch the audit logs from Google Cloud, it is possible to visualize the alerts generated in the Fortishield dashboard.
