...
.. meta::
  :description: Amazon Macie is a service that uses machine learning and pattern matching to protect sensitive data. Learn how to configure and monitor it with Fortishield.
...
#. You can select the compression you prefer. Fortishield supports any kind of compression but Snappy. After that, click on **Create new or choose**:
...
Below are some use cases for Fortishield alerts built for S3.
