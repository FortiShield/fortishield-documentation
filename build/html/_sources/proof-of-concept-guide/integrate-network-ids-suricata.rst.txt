...
.. meta::
   :description: Fortishield integrates with Suricata, a NIDS that detects threats by monitoring network traffic. Learn more about this in this PoC.

Network IDS integration
=======================

Fortishield integrates with a network-based intrusion detection system (NIDS) to enhance threat detection by monitoring network traffic.

In this use case, we demonstrate how to integrate Suricata with Fortishield. Suricata can provide additional insights into your network's security with its network traffic inspection capabilities.
...
+===============+=================================================================================================================================================+
| Ubuntu 22.04  | This is the endpoint where you install Suricata. In this use case, Fortishield monitors and analyzes the network traffic generated on this endpoint.  |
+---------------+-------------------------------------------------------------------------------------------------------------------------------------------------+

Configuration
-------------

Take the following steps to configure Suricata on the Ubuntu endpoint and send the generated logs to the Fortishield server.
...
#. Add the following configuration to the ``/var/ossec/etc/ossec.conf`` file of the Fortishield agent. This allows the Fortishield agent to read the Suricata logs file:
...
Fortishield automatically parses data from ``/var/log/suricata/eve.json`` and generates related alerts on the Fortishield dashboard.

Ping the Ubuntu endpoint IP address from the Fortishield server:
