...
.. meta::
   :description: If you want to know how to migrate from OSSEC to Fortishield, check this section where we explain how to do it without losing configuration data or agent keys.
...
Install Fortishield server
--------------------

Now it's time to install the Fortishield server component. Read the :doc:`Installing Fortishield server </installation-guide/fortishield-server/index>` section for detailed instructions. Read the :doc:`/deployment-options/fortishield-from-sources/fortishield-server/index` section for an alternative to this.
...
.. code-block:: console
   ...
   $ sudo systemctl stop fortishield-manager
...
.. code-block:: console
   ...
   $ sudo systemctl start fortishield-manager
